            ...
            currentList.map((item) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto justify-end border-t sm:border-t-0 pt-3 sm:pt-0 border-zinc-800/60">
                  ...
                  {/* শর্তসাপেক্ষ রেন্ডারিং: শুধু 'Today's Plan' ট্যাবে থাকলেই 'Mark as Done' বাটন দেখাবে */}
                  {activeTab === "plan" && (
                    <button className="px-4 py-2 rounded-full bg-[#ccff00] hover:bg-[#b8e600] text-black text-xs font-bold transition flex items-center gap-1.5">
                      ✓ Mark as Done
                    </button>
                  )}
